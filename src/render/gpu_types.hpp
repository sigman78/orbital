...
static_assert(sizeof(CullRoot) == 40 && sizeof(RockData) == 48 && sizeof(DrawArgs) == 32);
...
static_assert(offsetof(CullParams, index_counts) == 144 && sizeof(CullParams) == 144 + 12 * ORBITAL_ROCK_GROUPS);
