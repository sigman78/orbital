...
// irregular captured body rendered as a rock. Planetoid: a small airless world
// whose surface is generated (scene/terrain.hpp), not mapped.
enum class BodyClass { Terrestrial, GasGiant, RockyMoon, Desert, Moonlet, Planetoid };
